...
export const MenuCard = ({
  ...
  return (
    <div className="flex h-[14.85cm] w-[10.5cm] flex-col items-center justify-between gap-6 rounded-lg border-2 border-muted bg-secondary p-10">
      <div className="flex flex-col items-center gap-6">
        ...
        <div className="flex flex-col gap-2">
          <div className="flex w-full flex-row flex-wrap items-center gap-2 border-b border-foreground pb-1">
            {instagramEnabled && (
