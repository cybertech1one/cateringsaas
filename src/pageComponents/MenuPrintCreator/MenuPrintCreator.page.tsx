  ...
  return (
    <div className="flex w-full flex-col gap-6 px-8 md:flex-row">
      <div className="flex w-full max-w-[300px] grow flex-col gap-8">
        <h1 className="font-display text-3xl font-bold tracking-tight">{t("menuPrintCreator.title")}</h1>
        <Form {...form}>
      ...
      <MenuPdfGenerator
        {...debouncedValues}
        qrCodeUrl={`${(process.env.NEXT_PUBLIC_APP_URL ?? "https://www.feastqr.com").replace(/^https?:\/\//, "").replace(/\/$/, "")}/menu/${slug}`}
